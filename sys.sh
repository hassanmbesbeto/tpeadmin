...
echo "................................................................................"
echo "................................................................................" 
echo ".........................By MBESBETO HASSAN AWALOU  14A286FS ..................."
echo "................................................................................"
echo "................................................................................"
read -r choix
case $choix in 
...
;;
	...
	mkdir -p /home/hassan-hp-15-notebook-pc/archive
	find /home/hassan-hp-15-notebook-pc/ -type f -mtime 2 -print>/home/hassan-hp-15-notebook-pc/ficmodi
	while read line
	do
	cp $line archive
	done </home/hassan-hp-15-notebook-pc/ficmodi
	tar -czvf archive.tar.gz archive
	#mv archive.tar.gz /media/usb/*/archive.tar.gz
	mv archive.tar.gz /home/hassan-hp-15-notebook-pc/prof/archive.tar.gz
	;;
